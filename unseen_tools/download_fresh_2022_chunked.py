...
OUT = Path(r"D:\oro_top40_shortmem_OLD\fresh_2022")
SYMBOL = "XAUUSD"
START = pd.Timestamp("2021-12-01T00:00:00Z")
END = pd.Timestamp("2023-01-05T23:59:00Z")
EVAL_START = pd.Timestamp("2022-01-01T00:00:00Z")
EVAL_END = pd.Timestamp("2022-12-31T23:59:59Z")
TIMEFRAMES = {
...
def main() -> None:
    ...
    try:
        for name, (tf, minutes) in TIMEFRAMES.items():
            ...
            path = OUT / f"XAUUSD_{name}_FRESH_2022.csv"
    ...
    out_manifest = OUT / "FRESH_2022_DOWNLOAD_MANIFEST.json"
    out_manifest.write_text(json.dumps(manifest, indent=2), encoding="utf-8")
    print("\nFRESH_2022_DOWNLOAD=PASS")
